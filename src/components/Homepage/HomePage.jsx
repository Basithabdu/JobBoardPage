            ...
            <div className="card">
              <div className="card-body d-flex align-items-center">
                ...
                <div className="ms-3">
                  ...
                  <Button className="san mx-2"><b>San Francisco</b></Button>
            ...
            <div className="card">
              <div className="card-body d-flex align-items-center">
                ...
                <div className="ms-3">
                  ...
                  <p className="text-muted">by <b>Uxper</b> in <b><span className="develop">Development & IT</span></b></p>
                  <Button className="remote mx-2"><b>Remote</b></Button>
                  <Button className="san ms-2 mx-2"><b>San Francisco</b></Button>
                  <Button className="doller ms-2 mb-3"><b>"$100 - $200/month</b></Button>
